...
const ipMask = data.match(/(?<=(?:(?:[1-9]{0,3}\.[1-9]{0,3}){3}))(?:\/[1-9]{0,2})/)[0]; //get the mask
const netAddr = `${ipAddr.match(/(?:(?:[1-9]{0,3}\.[1-9]{0,3}){2})/)[0]}.0${ipMask}`; //gets only 3 octets from ipAddr, replaces the last octet by 0 and adds the ipMask
